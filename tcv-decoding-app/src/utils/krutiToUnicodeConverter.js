function krutiToUnicdeConvertor(input) {
    var begin = 0; // 0 if starting with kruti dev, 1 if starting with unicode
    var legacy_text_var = input; // in Kruti Dev
      ...
      function Replace_Symbols() {
        ...
        if (modified_substring != "")  // if stringto be converted is non-blank then no need of any processing.
        {
          ...
          */
          ...
          let probable_position_of_half_r;
    ...
    return unicode_text_var?.split(' ');

}

export default krutiToUnicdeConvertor;